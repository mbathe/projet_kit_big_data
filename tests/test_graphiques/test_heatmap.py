...
def test_heatmap_afficher(mock_plotly_chart, sample_data):
    ...
    assert (
        coloraxis.tickfont.color == "black"
    ), "La couleur de la police des ticks de la barre de couleur n'est pas 'black'."
    assert (
        coloraxis.titlefont.color == "black"
    ), "La couleur de la police du titre de la barre de couleur n'est pas 'black'."
