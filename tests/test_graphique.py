...
@patch('src.graphique.st.plotly_chart')
def test_boxplot_afficher(mock_plotly_chart, sample_data):
    ...
    assert xaxes.title_font.color == 'black', "La couleur de la police du titre de l'axe x n'est pas 'black'."
    ...
    assert yaxes.title_font.color == 'black', "La couleur de la police du titre de l'axe y n'est pas 'black'."
